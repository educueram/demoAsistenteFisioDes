  ...
  try {
    ...
    if (esClienteConNombre) {
      ...
      informacionClientePrompt = [
        ...
        '',
        '🔎 FLUJO OBLIGATORIO',
        '🔎 PROCESO OBLIGATORIO Y NO NEGOCIABLE: Debes identificar el dia de forma perfecta que el paciente indique, ya sea que te lo diga en texto o con numero, ',
        'NO PUEDES ESTAR CONFUNDIENDOTE para identificar el día, si no puedes indentificar el día, no mandes Error: Formato de fecha invalido, mejor cambialo por: No logre consultar ese día, me puedes indicar alguno otro?',
      ...
      informacionClientePrompt = [
        ...
        '',
        '**ORDEN OBLIGATORIO:** Servicio → Consulta automática día → Selección de hora → Verificación de cliente → Email → Confirmación → Agendar',
