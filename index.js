  ...
  try {
    ...
    if (esClienteConNombre) {
      ...
      informacionClientePrompt = [
        ...
        'TEN EN CONSIDERACIÓN EN USAR EL NOMBRE DEL PACIENTE Y EL CORREO PARA PRELLENAR LOS DATOS DEL PACIENTE CUANDO SE AGENDE UNA CITA',
        `Nombre paciente: "${nombreParaSaludo}"`,
        `Correo paciente: "${correoParaPrompt}"`,
